...
| property | pro | Swift/iOS 문맥에서 property가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| instance | ins | Swift/iOS 문맥에서 instance가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| reference | ref | Swift/iOS 문맥에서 reference가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| value | val | Swift/iOS 문맥에서 value가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| state | sta | Swift/iOS 문맥에서 state가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| binding | bin | Swift/iOS 문맥에서 binding가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| dependency | dep | Swift/iOS 문맥에서 dependency가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| constraint | con | Swift/iOS 문맥에서 constraint가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| configuration | con | Swift/iOS 문맥에서 configuration가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| environment | env | Swift/iOS 문맥에서 environment가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
...
* argument: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* parameter: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* property: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* instance: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* reference: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* value: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* state: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* binding: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* dependency: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* constraint: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* configuration: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* environment: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* scope: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* lifecycle: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* thread: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* task: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* actor: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* queue: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* request: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.
* response: Swift 코드에서 값, 타입, 설정, 흐름 중 어디에 속하는지 말한다.

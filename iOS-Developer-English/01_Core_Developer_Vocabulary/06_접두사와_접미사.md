...
|---|---|---|---|
| un- | un- | Swift/iOS 문맥에서 un-가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| in- | in- | Swift/iOS 문맥에서 in-가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| re- | re- | Swift/iOS 문맥에서 re-가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| pre- | pre | Swift/iOS 문맥에서 pre-가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| de- | de- | Swift/iOS 문맥에서 de-가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -able | -ab | Swift/iOS 문맥에서 -able가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -ed | -ed | Swift/iOS 문맥에서 -ed가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -ing | -in | Swift/iOS 문맥에서 -ing가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -tion | -ti | Swift/iOS 문맥에서 -tion가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -ment | -me | Swift/iOS 문맥에서 -ment가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -er | -er | Swift/iOS 문맥에서 -er가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
| -or | -or | Swift/iOS 문맥에서 -or가 가리키는 역할을 파악한다 | 일반 영어의 기본 의미 |
...
* unavailable = un + available, configuration = configure + ation.
